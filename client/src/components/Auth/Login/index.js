...
const Login = () => { 
  return(<>
        ...
        {/* feedback et message d'erreurs */}
          ...
          */}
          ...
          <div className="form-group">
				    <Input.Password label="Mot de pass" name="password" style={{padding: 0}}  onChange={() => null} />
          </div>
          <div className="form-group"> 
					  <Input.Checkbox col="6">Se souvenir de moi</Input.Checkbox>
				  </div>   
          <div className="form-group">
     ...
     <p className="text-center mt-4">Je n'ai pas de compte? <Link to='/register'>je m'inscris</Link></p>
		<br /><br />
	</>)
}  
