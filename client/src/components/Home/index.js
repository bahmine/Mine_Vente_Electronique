...
const Deals = () => ( 
 ...
 <div className="card card-deal">
     <div className="col-heading content-body">
      <header className="section-heading">
       <h3 className="section-title">Offres</h3>
       <p>Équiments d'hygiène</p>
     </header>
     <div className="timer">
    ...
    <div className="col-md col-6">
     <figure className="card-product-grid card-sm">
      ...
      <div className="text-wrap p-3">
       	<a href="#" className="title">Quelques offres</a>
 ...
 <div className="col-md col-6">
   ...
   <div className="text-wrap p-3">
     <a href="#" className="title">Quelques catégories</a>
...
<div className="col-md col-6">
 ...
 <div className="text-wrap p-3">
   <a href="#" className="title">Autre catégorie</a>
   <span className="badge badge-danger"> -20% </span>
 </div>
</figure>
</div> 
<div className="col-md col-6">
 ...
 <div className="text-wrap p-3">
   <a href="#" className="title">Pour maison</a>
...
<div className="col-md col-6">
 ...
 <div className="text-wrap p-3">
   <a href="#" className="title text-truncate">Montres intelligentes</a>
